        ...
        <div className=" justify-around border-b px-10 py-4 bg-white">
          <div className="">
            ...
            <p className=" text-sm sm:text-base md:text-lg leading-relaxed text-gray-600 py-2">
              Need a private office? Our fully-serviced spaces are designed for
              privacy, productivity, and flexibility, with access to essential
              amenities for seamless work.
            </p>
          </div>
        </div>
