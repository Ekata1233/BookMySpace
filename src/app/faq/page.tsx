...
function FAQs() {
    const faqData = [
        ...
        },
        {
            ...
            answer: "Absolutely! You can override styles or replace components as needed.",
        },
        {
        ...
        },
        {
            ...
            answer: "Yes. It's fully keyboard accessible as per accessibility guidelines.",
        },
    ];
    return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start py-30">
                ...
                <div>
                    ...
                    <p className="text-sm sm:text-base md:text-lg leading-relaxed pt-5">
                        Can’t see an answer to your question? Get in touch with our team who are always happy to help.
                    </p>
                    <p style={{ display: "flex", alignItems: "center", gap: "8px" }} className='py-5'>
