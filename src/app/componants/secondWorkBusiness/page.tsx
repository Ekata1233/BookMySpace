 ...
 sm:mt-0 md:mt-0 lg:mt-0 "
        ...
        <div className="relative flex justify-center items-center h-64 sm:h-80 md:h-96 lg:h-[28rem] xl:h-[32rem]">
          ...
          <Image
            ...
            src="/business_1.png"
            alt="Top Image"
            className="w-50 sm:w-40 md:w-55 lg:w-60 xl:w-64 shadow-lg transform translate-x-24 sm:translate-x-20 md:translate-x-18 lg:translate-x-32 xl:translate-x-35 -translate-y-4 sm:-translate-y-6 md:-translate-y-35 lg:-translate-y-27 absolute z-0"
          />
          ...
          <Image
            ...
            src="/business_2.png"
            alt="Bottom Image"
            className="w-70 sm:w-56 md:w-75 lg:w-80 xl:w-80 shadow-lg transform -translate-x-14 sm:translate-x-4 md:-translate-x-7 lg:-translate-x-20 xl:-translate-x-15 translate-y-30 sm:translate-y-20 md:translate-y-16 lg:translate-y-28 xl:translate-y-28 z-10"
          />
        </div>
      </div>
    </div>
