  ...
  return (
    <div className=" my-12 mx-2 sm:mx-6 md:mx-8 lg:mx-12 xl:mx-16">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="w-full md:w-1/2 border-b-2">
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-700 text-start py-2">
        ...
        <div className="w-full md:w-1/2 bg-gray-100 py-5  shadow-lg">
          ...
          {/* <div className="flex flex-wrap justify-center">
            {MatchedOfficeSpace.amenities.map((amenity, index) => {
              ...
              return (
                <div
                  key={index}
                  className="w-[37%] flex flex-col items-center text-center my-3"
                >
                  {IconComponent && (
                    <IconComponent className="text-6xl text-[#6BB7BE]" />
                  )}
                  <p className="font-semibold my-2">{amenity}</p>
                </div>
              );
            })}
          </div> */}
          ...
          <div className="flex flex-wrap justify-center">
            {MatchedOfficeSpace.amenities.map((amenity, index) => {
              ...
              return (
                <div
                  key={index}
                  className="w-[25%] flex flex-col items-center text-center my-4"
                >
                  {IconComponent && (
                    <IconComponent className="text-6xl text-[#6BB7BE]" />
                  )}
