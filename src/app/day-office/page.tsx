      ...
      <div className="relative z-10 mx-auto -mt-30 w-[90%] md:w-[80%] lg:w-[85%] xl:w-[60%] shadow-lg">
        ...
        <div className=" justify-around border-b px-10 py-4 bg-white">
          <div className="">
            ...
            Get a fully-equipped day office for a productive workday, with privacy, high-speed internet, and access to essential amenities—perfect for short-term use.
            </p>
          </div>
        </div>
