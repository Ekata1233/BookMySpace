        ...
        <div className=" justify-around border-b px-10 py-4 bg-white">
          <div className="">
            ...
            <p className=" text-sm sm:text-base md:text-lg leading-relaxed text-gray-600 py-2">
              Ensure business continuity with a workplace recovery solution that
              provides a fully-equipped office, secure infrastructure, and
              essential support during disruptions.
            </p>
          </div>
        </div>
